...
def runSys(): 
    ...
    t.goto(-650, 180)
    text1 = t.write("MAKE FILE", font = ("terminal", 21, "normal"))
    ...
    obj4.penup()
    obj4.goto(-610, -115)
    obj4.color("white", "black")
    obj4.shapesize(stretch_len = 3, stretch_wid = 2)
    obj4.shape("square")

    t.goto(-645, -185)
    text4 = t.write("TERMINAL", font = ("terminal", 21, "normal"))
    """
    ...
    obj7.goto(-485, 0)
    obj7.color("white")
    obj7.shapesize(stretch_len = 2, stretch_wid = 3)
    obj7.shape("square")

    t.goto(-527, -70)
    text7 = t.write("OPEN FILE", font = ("terminal", 21, "normal"))
    """
